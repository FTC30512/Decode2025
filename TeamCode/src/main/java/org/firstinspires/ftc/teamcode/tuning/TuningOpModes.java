...
import org.firstinspires.ftc.teamcode.roadrunnerSetup.OTOSLocalizer;
import org.firstinspires.ftc.teamcode.roadrunnerSetup.PinpointLocalizer;
import org.firstinspires.ftc.teamcode.roadrunnerSetup.TankDrive;
import org.firstinspires.ftc.teamcode.roadrunnerSetup.ThreeDeadWheelLocalizer;
import org.firstinspires.ftc.teamcode.roadrunnerSetup.TwoDeadWheelLocalizer;
    ...
    private static PinpointView makePinpointView(PinpointLocalizer pl) {
        return new PinpointView() {
            ...
            public float getHeadingVelocity() {
                return (float) pl.driver.getHeadingVelocity(UnnormalizedAngleUnit.RADIANS); // or DEGREES, pick appropriate
            }
